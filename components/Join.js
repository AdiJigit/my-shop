...
export default function Join() {
  return (
    <div className="mt-[150px] min-h-[25vh] flex">
      <div className="flex-1 flex justify-center items-center border-t border-t-black border-b border-b-black text-3xl font-[500]">
